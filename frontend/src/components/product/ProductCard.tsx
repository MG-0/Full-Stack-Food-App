...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
      <Link href={`/products/${product._id}`} className="block flex-grow flex flex-col">
        {/* Image */}
      ...
      {/* Action Footer */}
      <div className="px-5 pb-5 flex items-center justify-between pt-2 border-t border-gray-50">
